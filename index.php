...
<head>
    ...
    <style>
        ...
        .gradient-bg {
            background: linear-gradient(to right, #e4c3e0, #fcc9c6, #fee6c4, #bbd2fe);
        }

        .tab-content.active .animated-item {
...
<body class="bg-white text-slate-800">
    ...
    <header class="sticky top-0 bg-white/90 backdrop-blur-lg z-20 border-b border-slate-200">
        <div class="px-4 sm:px-6 h-20 flex items-center justify-between">
            ...
            <img src="assets/images/logo.png" alt="EmpireOne Logo"
                class="h-10 sm:h-12 w-auto drop-shadow-[0_2px_6px_rgba(0,0,0,0.3)] hover:scale-105 transition-transform duration-300" /
                style="height: 55px;">
            <!-- Centered Nav Tabs -->
            <nav class="hidden md:flex flex-grow h-full justify-center">
                <div class="relative flex items-center justify-center h-full">
                    ...
                    <ul id="tab-list" class="relative flex items-center justify-center gap-x-8 h-full">
                        <li><a href="#"
                                class="tab-link z-10 px-4 py-2 rounded-lg flex items-center text-base font-medium transition-colors duration-300"
                                data-tab="dashboard"><i data-feather="grid" class="w-5 h-5 mr-2"></i>Dashboard</a></li>
                        <li><a href="#"
                                class="tab-link z-10 px-4 py-2 rounded-lg flex items-center text-base font-medium transition-colors duration-300"
                                data-tab="data-viewer"><i data-feather="database" class="w-5 h-5 mr-2"></i>Data
                                Viewer</a></li>
                        <li><a href="#"
                                class="tab-link z-10 px-4 py-2 rounded-lg flex items-center text-base font-medium transition-colors duration-300"
                                data-tab="upload"><i data-feather="upload-cloud" class="w-5 h-5 mr-2"></i>Upload</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="flex items-center">
                <div class="relative">
                    <button id="profile-button"
                        class="flex items-center space-x-2 p-1.5 pr-3 rounded-full hover:bg-slate-100 transition-colors duration-300">
                        <img src="https://placehold.co/40x40/ec4899/ffffff?text=<?= substr($sFullName, 0, 1) ?>" alt="User Avatar"
                            class="w-8 h-8 rounded-full">
                        <span class="font-medium text-sm text-slate-700 hidden sm:inline"><?= $sFullName ?></span>
                        <i id="profile-chevron" data-feather="chevron-down"
                            class="w-5 h-5 text-slate-500 transition-transform duration-300"></i>
                    </button>
                    <!-- Dropdown Menu -->
                    <div id="profile-dropdown"
                        class="profile-dropdown absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg overflow-hidden border border-slate-200">
                        ...
                        <div class="border-t border-slate-200 py-1">
                            <a href="logout.php"
                                class="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-red-50"><i
        ...
        <nav class="md:hidden bg-white border-t border-slate-200">
            <ul id="mobile-tab-list" class="flex items-center justify-around h-16">
                <li><a href="#"
                        class="tab-link z-10 p-2 rounded-lg flex flex-col items-center text-xs font-medium transition-colors duration-300"
                        data-tab="dashboard"><i data-feather="grid" class="w-5 h-5 mb-1"></i>Dashboard</a></li>
                <li><a href="#"
                        class="tab-link z-10 p-2 rounded-lg flex flex-col items-center text-xs font-medium transition-colors duration-300"
                        data-tab="data-viewer"><i data-feather="database" class="w-5 h-5 mb-1"></i>Data Viewer</a></li>
                <li><a href="#"
                        class="tab-link z-10 p-2 rounded-lg flex flex-col items-center text-xs font-medium transition-colors duration-300"
                        data-tab="upload"><i data-feather="upload-cloud" class="w-5 h-5 mb-1"></i>Upload</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main class="gradient-bg min-h-screen">
        <div class="p-4 sm:p-6 md:p-8">
            ...
            <div id="dashboard" class="tab-content">
                <div class="flex justify-between items-center bg-white p-6 rounded-xl shadow-md mb-8 animated-item border border-slate-200"
                    ...
                    <button id="quick-guide-button"
                        class="p-3 bg-pink-100 rounded-lg hover:bg-pink-200 transition-colors">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Stat Cards -->
                    <div class="bg-white p-5 rounded-xl shadow-md border-b-4 border-pink-500 animated-item transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-md border-b-4 border-fuchsia-500 animated-item transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-md border-b-4 border-sky-500 animated-item transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                        style="opacity:0; animation-delay: 500ms;">
                        <div class="flex justify-between items-start">
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-md border-b-4 border-indigo-500 animated-item transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                        style="opacity:0; animation-delay: 600ms;">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 mt-6">
                    <div class="lg:col-span-3 bg-white p-6 rounded-xl shadow-md animated-item border border-slate-200"
                        style="opacity:0; animation-delay: 700ms;">
                        <h3 class="text-lg font-semibold text-slate-800 mb-4">Monthly Financial Trends</h3>
                        <div id="financialTrendsChart"></div>
                    </div>
                    <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-md animated-item border border-slate-200"
                        style="opacity:0; animation-delay: 800ms;">
            ...
            <div id="data-viewer" class="tab-content">
                ...
                <div class="bg-white rounded-xl shadow-md p-4 animated-item border border-slate-200"
                    style="opacity:0; animation-delay: 100ms;">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        <input type="text" placeholder="Search supplier, order #..."
                            class="w-full lg:col-span-2 bg-slate-50 border border-slate-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none">
                        <select id="supplierSelect"
                            class="w-full bg-slate-50 border border-slate-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none">
                        ...
                        <div class="flex justify-end gap-x-2">
                            <button id="resetFiltersBtn"
                                class="px-4 py-2 text-sm font-medium text-slate-700 bg-slate-100 rounded-lg hover:bg-slate-200">Reset</button>
                            <button class="px-4 py-2 text-sm font-medium text-white bg-pink-500 rounded-lg hover:bg-pink-600">Export Excel</button>
                        </div>
                    </div>
                </div>

                <div class="mt-6 bg-white rounded-xl shadow-md animated-item border border-slate-200 p-6 overflow-x-auto"
            ...
            <div id="upload" class="tab-content">
                <div class="flex justify-between items-center bg-white p-6 rounded-xl shadow-md mb-8 animated-item border border-slate-200"
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-base md:text-lg">Upload financial documents for AI-powered data
                ...
                <div class="bg-white rounded-xl shadow-md p-6 md:p-8 animated-item border border-slate-200"
                    style="opacity:0; animation-delay: 100ms;">
                    <h3 class="text-lg font-semibold text-slate-800 mb-2">Upload Financial Documents</h3>
                    <div id="dropzone"
                        class="mt-6 border-2 border-dashed border-slate-300 rounded-xl p-12 text-center cursor-pointer hover:border-pink-500 transition-all duration-300 group hover:bg-pink-50/50">
                        <div class="flex flex-col items-center text-slate-500">
                            <div
                                class="w-16 h-16 bg-pink-50 rounded-full flex items-center justify-center mb-4 transition-all duration-300 group-hover:scale-110">
                ...
                <div class="bg-white rounded-xl shadow-md p-8 mt-6 animated-item border border-slate-200"
                    style="opacity:0; animation-delay: 200ms;">
                    <h3 class="text-xl font-semibold text-slate-800 mb-8 text-center">How It Works</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div class="flex flex-col items-center">
                            <div class="w-16 h-16 bg-pink-100 rounded-full flex items-center justify-center mb-4"><i
                                    data-feather="file-plus" class="w-8 h-8 text-pink-500"></i></div>
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-16 h-16 bg-fuchsia-100 rounded-full flex items-center justify-center mb-4"><i
                                    data-feather="cpu" class="w-8 h-8 text-fuchsia-500"></i></div>
                            <h4 class="font-semibold text-base mb-2">2. Enhance</h4>
                            <p class="text-base text-slate-500">AI automatically enhances image quality and removes
                                noise.</p>
                        </div>
                        <div class="flex flex-col items-center">
                            <div class="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mb-4"><i
                                    data-feather="check-circle" class="w-8 h-8 text-sky-500"></i></div>
    ...
    <div id="quick-guide-modal-overlay" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50 p-4">
        <div id="quick-guide-modal-content"
            class="modal-content bg-slate-50 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div class="p-6 border-b sticky top-0 bg-slate-50/80 backdrop-blur-sm">
                <div class="flex justify-between items-center">
                    ...
                    <button id="close-modal" class="p-1 rounded-full hover:bg-slate-200"><i data-feather="x"
                            class="w-5 h-5 text-slate-600"></i></button>
                </div>
                <p class="text-slate-600 mt-1">Welcome to the Finance AI Extraction System! This quick guide will help
                    you get started.</p>
            </div>
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-white rounded-lg p-5 border-l-4 border-blue-500 shadow-sm">
                    ...
                    <p class="text-slate-600 mb-3 text-sm">Start by uploading your financial documents (receipts,
                        invoices, bills, statements).</p>
                    ...
                    <div class="mt-4"><span
                            class="text-xs font-medium bg-blue-100 text-blue-700 px-2 py-1 rounded-full">Navigate to
                ...
                <div class="bg-white rounded-lg p-5 border-l-4 border-purple-500 shadow-sm">
                    ...
                    <p class="text-slate-600 mb-3 text-sm">Our AI automatically analyzes and extracts financial data
                    ...
                    <div class="mt-4"><span
                            class="text-xs font-medium bg-purple-100 text-purple-700 px-2 py-1 rounded-full">Automatic
                            processing</span></div>
                </div>
                <div class="bg-white rounded-lg p-5 border-l-4 border-green-500 shadow-sm">
                    ...
                    <div class="mt-4"><span
                            class="text-xs font-medium bg-green-100 text-green-700 px-2 py-1 rounded-full">Data Viewer
                            page</span></div>
                </div>
                <div class="bg-white rounded-lg p-5 border-l-4 border-orange-500 shadow-sm">
                    ...
                    <div class="mt-4"><span
                            class="text-xs font-medium bg-orange-100 text-orange-700 px-2 py-1 rounded-full">Data Viewer
                            → Export</span></div>
                </div>
                <div class="md:col-span-2 bg-white rounded-lg p-5 border-l-4 border-indigo-500 shadow-sm">
                    ...
                    <div class="mt-4"><span
                            class="text-xs font-medium bg-indigo-100 text-indigo-700 px-2 py-1 rounded-full">Dashboard
                            page</span></div>
                </div>
            </div>
        </div>
